...
/// <summary>
/// Ross Cameron style daily high breakout strategy.
/// </summary>
public sealed class DailyHighBreakoutStrategy : IStrategy
{
    public string Name => "Daily High Breakout";

    public bool ShouldEnter(BarContext context, StrategyConfig config)
    {
        ...
        return context.Bar.High > context.RunningDailyHigh;
    }
